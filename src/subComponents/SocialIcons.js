...
const SocialIcons = (props) => {
  return (
    <Icons>
        ...
        >
            <NavLink style={{color:'inherit'}} targets="_blank"  to={{pathname:"https://github.com/yema24"}}>
        ...
        >
            <NavLink style={{color:'inherit'}} targets="_blank"  to={{pathname:"https://twitter.com/onyemagift"}}>
        ...
        >
            <NavLink style={{color:'inherit'}} targets="_blank"  to="/">
